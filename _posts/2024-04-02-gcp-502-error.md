...
description: "The HTTP 502 Bad Gateway server error response code indicates an issue where the server, acting as a gateway or proxy, has received an invalid response from"
