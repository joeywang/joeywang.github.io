...
description: "k3s is a lightweight Kubernetes distribution designed for production workloads in unattended, remote locations. It is a fully compliant Kubernetes runtime that"
